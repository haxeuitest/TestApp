...
extern class Component extends haxe.ui.backend.ComponentImpl implements haxe.ui.validation.IValidating {
    ...
    private function onComponentCreated():Void;
    ...
    public function swapClasses(classesToAdd:Array<String>, ?classesToRemove:Null<Array<String>>, ?invalidate:Bool, ?recursive:Bool):Void;
    public function toggleClass(name:String, ?invalidate:Bool, ?recursive:Bool):Void;
    ...
    private var recursivePointerEvents:Bool;
    ...
    public var horizontalSpacing(get, set):Null<Float>;
    private function get_horizontalSpacing():Null<Float>;
    private function set_horizontalSpacing(value:Null<Float>):Null<Float>;
    public var verticalSpacing(get, set):Null<Float>;
    private function get_verticalSpacing():Null<Float>;
    private function set_verticalSpacing(value:Null<Float>):Null<Float>;

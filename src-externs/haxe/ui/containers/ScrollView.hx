...
extern class ScrollView extends haxe.ui.core.InteractiveComponent implements haxe.ui.core.IScroller {
    ...
    public var scrollMouseButton(get, set):haxe.ui.constants.MouseButton;
    private function get_scrollMouseButton():haxe.ui.constants.MouseButton;
    private function set_scrollMouseButton(value:haxe.ui.constants.MouseButton):haxe.ui.constants.MouseButton;
    ...
    public var isScrollableHorizontally(get, set):Bool;
    private function get_isScrollableHorizontally():Bool;
    private function set_isScrollableHorizontally(value:Bool):Bool;
    public var isScrollableVertically(get, set):Bool;
    private function get_isScrollableVertically():Bool;
    private function set_isScrollableVertically(value:Bool):Bool;
    public var isScrollable(get, set):Bool;
    private function get_isScrollable():Bool;
    private function set_isScrollable(value:Bool):Bool;
    public var emptyContentsComponent(get, set):haxe.ui.core.Component;
    private function get_emptyContentsComponent():haxe.ui.core.Component;
    private function set_emptyContentsComponent(value:haxe.ui.core.Component):haxe.ui.core.Component;
    public var emptyContentsText(get, set):String;
    private function get_emptyContentsText():String;
    private function set_emptyContentsText(value:String):String;
...
extern class ScrollViewEvents extends haxe.ui.events.Events {
    ...
    private function onLeftMouseDown(event:haxe.ui.events.MouseEvent):Void;
    private function onMiddleMouseDown(event:haxe.ui.events.MouseEvent):Void;
    private function onRightMouseDown(event:haxe.ui.events.MouseEvent):Void;
...
extern class ScrollViewBuilder extends haxe.ui.core.CompositeBuilder {
    ...
    private function checkEmptyContentsComponent(?contentsComponent:Null<haxe.ui.core.Component>):Void;
    ...
    private function onContentsChanged(event:haxe.ui.events.UIEvent):Void;
